      ...
      <div className='max-w-4xl mx-auto px-6'>
        <header className='flex items-center justify-between py-6'>
          ...
          <nav className='hidden md:flex items-center gap-6 text-sm'>
            ...
            <a href="#resume" className="ml-4 px-3 py-1 border rounded-md text-sm hover:bg-slate-50">Resume</a>
          </nav>
          <button 
          ...
          <div className='grid gap-8 md:grid-cols-2 md:items-center'>
            <div>
              ...
              <div className='mt-6 flex gap-3'>
                <a href="#projects" className='inline-block px-5 py-2 rounded-md bg-blue-600 text-white font-medium shadow-sm hover:opacity-60'>View Projects</a>
                <a href="#contacts" className='inline-block px-5 py-2 rounded-md border text-sm hover:bg-slate-200'>Contact Me</a>
              </div> 
            </div>
