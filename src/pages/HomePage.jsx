                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-8 py-4">
                    ...
                    <header className="flex items-center justify-between p-4 rounded-xl border border-slate-200/80 dark:border-slate-800/80 bg-white/70 dark:bg-[#121826]/70 backdrop-blur-md shadow-sm">
                        <Link to="/" className="inline-flex items-center gap-3 group">
                            ...
                            <div className="flex flex-col">
                                <span className="text-sm font-bold tracking-tight font-mono text-slate-900 dark:text-white">Sowhardo.bin()</span>
                                <span className="text-[10px] text-indigo-600 dark:text-indigo-400 font-mono tracking-widest uppercase">Backend Eng</span>
                            </div>
                        </Link>
                    ...
                    <main className="py-16 md:py-28 relative">
                        ...
                        <div className="border-l-2 border-indigo-500 pl-4 md:pl-6 space-y-4">
                            <span className="text-xs font-mono uppercase tracking-widest text-indigo-600 dark:text-indigo-400 font-semibold">Undergrad Ledger // Systems</span>
                            <h1 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight text-slate-900 dark:text-white leading-[1.15]">
                                Hi, I'm Sowhardo, a Final Semester CSE student & an <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-cyan-500 dark:from-indigo-400 dark:to-cyan-400">AI driven Backend Developer.</span>
                            </h1>
                        </div>
                        
                        {/* Interactive Tag Chips */}
                        <div className="mt-8 flex flex-wrap gap-2 font-mono text-[11px] max-w-2xl text-slate-500 dark:text-slate-400">
                            <span className="px-2.5 py-1 rounded bg-slate-200/60 dark:bg-[#161D30] border border-slate-300/40 dark:border-slate-800">Full Stack</span>
                            <span className="px-2.5 py-1 rounded bg-slate-200/60 dark:bg-[#161D30] border border-slate-300/40 dark:border-slate-800">Backend Systems</span>
                            <span className="px-2.5 py-1 rounded bg-slate-200/60 dark:bg-[#161D30] border border-slate-300/40 dark:border-slate-800">Distributed Infrastructure</span>
                            <span className="px-2.5 py-1 rounded bg-slate-200/60 dark:bg-[#161D30] border border-slate-300/40 dark:border-slate-800">Agentic AI Workflows</span>
                        </div>
                    ...
                    <section id="skills" className="py-16 border-t border-slate-200 dark:border-slate-800/80">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div className="p-5 rounded-xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-[#121826] shadow-sm">
                                <div className="flex items-center gap-2 text-xs font-mono text-indigo-600 dark:text-indigo-400 font-bold mb-3">
                                    <span>$ docker network inspect db</span>
                                </div>
                                <ul className="space-y-2 text-xs text-slate-600 dark:text-slate-300">
                            ...
                            <div className="p-5 rounded-xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-[#121826] shadow-sm">
                                <div className="flex items-center gap-2 text-xs font-mono text-indigo-600 dark:text-indigo-400 font-bold mb-3">
                                    <span>$ systemctl status reverse-proxy</span>
                                </div>
                                <ul className="space-y-2 text-xs text-slate-600 dark:text-slate-300">
                            ...
                            <div className="p-5 rounded-xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-[#121826] shadow-sm">
                                <div className="flex items-center gap-2 text-xs font-mono text-indigo-600 dark:text-indigo-400 font-bold mb-3">
                                    <span>$ tree /cs_fundamentals</span>
                                </div>
                                <ul className="space-y-2 text-xs text-slate-600 dark:text-slate-300">
                        ...
                        <div className="mt-4 p-4 rounded-xl bg-slate-100 dark:bg-[#161D30] border border-slate-200 dark:border-slate-800/80 font-mono text-xs">
                            <div className="text-indigo-600 dark:text-indigo-400 font-bold uppercase mb-2">// Active R&D Workloads:</div>
                            <ul className="space-y-1.5 list-inside list-square text-slate-600 dark:text-slate-300 text-[11px]">
                                <li>Adding an architectural <span className="font-semibold text-slate-900 dark:text-white">API rate limiter</span> layer into the MetroSheba engine.</li>
                                ...
                                <li>Developing an isolated Python-engineered <span className="font-semibold text-slate-900 dark:text-white">AI Coding Agent</span> to model system operations under the hood.</li>
                            </ul>
                        </div>
                    </section>
                    ...
                    <section id="contact" className="py-16 border-t border-slate-200 dark:border-slate-800/80">
                        <div className="max-w-3xl mx-auto">
                            <div className="text-center md:text-left mb-8">
                                <h2 className="text-xs font-mono uppercase tracking-widest text-indigo-600 dark:text-indigo-400 font-bold">03 // Communication Gate</h2>
                                <p className="text-xl font-extrabold text-slate-900 dark:text-white mt-1">Connect with the System</p>
                            </div>
                    ...
                    <footer className="py-8 text-center font-mono text-[10px] tracking-widest text-slate-400 dark:text-slate-600 border-t border-slate-200 dark:border-slate-800/40">
                        © {new Date().getFullYear()} SOWHARDO_BIN_ATIK // CORE_PORTFOLIO_NODE_v2
                    </footer>
                </div>
            </div>
        </div>
